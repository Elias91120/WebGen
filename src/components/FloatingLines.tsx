...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  // If we have gradients, we assume black background, otherwise we use the default color function
  ...
  // Calculate alpha based on brightness for transparency
  float alpha = length(col);
  // Enhance brightness slightly
  col *= 1.5;
  
  // Output with transparency if black
  fragColor = vec4(col, alpha > 0.05 ? 1.0 : 0.0);
}
